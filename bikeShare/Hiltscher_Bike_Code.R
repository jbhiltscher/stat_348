...
vroom_write(x=test_preds, file="C:/Users/jbhil/Fall 2023/STAT_346/TestPreds.csv", delim=",")
...
test_preds <- predict(bike_pois_workflow, new_data = bikeTest) %>%
  ...
  mutate(datetime=as.character(format(datetime))) #needed for right format to Kaggle
## Write prediction file to CSV
vroom_write(x=test_preds, file="C:/Users/jbhil/Fall 2023/STAT_346/TestPreds_Pois.csv", delim=",")
